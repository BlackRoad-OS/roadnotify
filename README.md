...
**roadnotify** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
![blackroad](https://img.shields.io/badge/blackroad-black?style=flat-square) ![messaging](https://img.shields.io/badge/messaging-black?style=flat-square) ![real-time](https://img.shields.io/badge/real-time-black?style=flat-square) 
...
git clone https://github.com/BlackRoad-OS/roadnotify.git
cd roadnotify
